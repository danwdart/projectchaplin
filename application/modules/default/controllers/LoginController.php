    ...
    public function oauthAction()
    {
        ...
        $oauth = [
            ...
            'facebook' => [
                ...
                'redirect_uri' => 'http://'.$strVhost.'/login/oauth/provider/facebook',
            ...
            'twitter' => [
                'oauth_version' => 1,
                'callbackUrl' => 'http://'.$strVhost.'/login/oauth/provider/twitter',
            ...
            'identica' => [
                'oauth_version' => 1,
                'callbackUrl' => 'http://'.$strVhost.'/login/oauth/provider/identica',
